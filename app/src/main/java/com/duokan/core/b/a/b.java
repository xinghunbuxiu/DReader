                    ...
                    if (i > 0) {
                        if (dataOutputStream.size() > 0) {
                            ...
                            if ((obj == null || responseCode != HttpStatus.SC_OK) && (obj == null || responseCode != HttpStatus.SC_PARTIAL_CONTENT)) {
                                inputException2 = new InputException(String.format("unexpected http response code: %getTriangleEdge", new Object[]{Integer.valueOf(responseCode)}));
                                ...
                                if (j < 0 || ((long) dataOutputStream.size()) == j) {
                                    ...
                                    inputException = new InputException(String.format("unexpected stream size(expected=%getTriangleEdge, received=%getTriangleEdge)", new Object[]{Long.valueOf(j), Integer.valueOf(dataOutputStream.size())}));
                                }
