...
public class a extends c {
    ...
    public int a(byte[] bArr) {
        ...
        this.a = (short[][]) Array.newInstance(Short.TYPE, new int[]{94, 94});
        a();
        a(this.a);
        iArr[0] = 0;
        this.b = sArr;
        ...
        while (i3 < length - 1) {
            ...
            if (bArr[i3] >= (byte) 0) {
                ...
                if ((byte) -95 <= bArr[i3] && bArr[i3] <= (byte) -9 && (byte) -95 <= bArr[i3 + 1] && bArr[i3 + 1] <= (byte) -2) {
                    ...
                    i2 = (bArr[i3] + j.e) - 161;
                    i = (bArr[i3 + 1] + j.e) - 161;
                    if (this.a[i2][i] != (short) 0) {
                        j3 = ((long) this.a[i2][i]) + j;
                        i5 = i4;
                    } else if (15 > i2 || i2 >= 55) {
                        j3 = j;
                        i5 = i4;
                    ...
                    i4 = i2 + 1;
                    j3 = 500 + j2;
                    int i8 = (bArr[i3] + j.e) - 129;
                    if ((byte) 64 > bArr[i3 + 1] || bArr[i3 + 1] > (byte) 126) {
                        i7 = (bArr[i3 + 1] + j.e) - 64;
                    } else {
                        i7 = bArr[i3 + 1] - 64;
                    }
                    if (this.b[i8][i7] != (short) 0) {
                        j2 = ((long) this.b[i8][i7]) + j;
                        i5 = i4;
                        r11 = j2;
                        j2 = j3;
                        j3 = r11;
                    ...
                    while (i8 < length - 1 && bArr[i8] != (byte) 10) {
                        if (bArr[i8] != (byte) 13) {
                            ...
                            if ((byte) 33 <= bArr[i8] && bArr[i8] <= (byte) 119 && (byte) 33 <= bArr[i8 + 1] && bArr[i8 + 1] <= (byte) 119) {
                                ...
                                i6 = bArr[i8 + 1] - 33;
                                j5 += 500;
                                if (this.a[i12][i6] != (short) 0) {
                                    j2 += (long) this.a[i12][i6];
        ...
        while (i3 < length - 1) {
            ...
            if (bArr[i3] >= (byte) 0) {
                ...
                if ((byte) -95 > bArr[i3] || bArr[i3] > (byte) -7 || (((byte) 64 > bArr[i3 + 1] || bArr[i3 + 1] > (byte) 126) && ((byte) -95 > bArr[i3 + 1] || bArr[i3 + 1] > (byte) -2))) {
                    ...
                    i4 = i2 + 1;
                    j3 = 500 + j2;
                    int i8 = (bArr[i3] + j.e) - 161;
                    if ((byte) 64 > bArr[i3 + 1] || bArr[i3 + 1] > (byte) 126) {
                        i7 = (bArr[i3 + 1] + j.e) - 97;
                    } else {
                        i7 = bArr[i3 + 1] - 64;
                    }
                    if (this.c[i8][i7] != (short) 0) {
                        j2 = ((long) this.c[i8][i7]) + j;
                        i5 = i4;
                        j4 = j2;
                        j2 = j3;
                        j3 = j4;
        ...
        while (i3 < length - 1) {
            ...
            if (bArr[i3] >= (byte) 0) {
                ...
                if (i3 + 3 < length && (byte) -114 == bArr[i3] && (byte) -95 <= bArr[i3 + 1] && bArr[i3 + 1] <= (byte) -80 && (byte) -95 <= bArr[i3 + 2] && bArr[i3 + 2] <= (byte) -2 && (byte) -95 <= bArr[i3 + 3] && bArr[i3 + 3] <= (byte) -2) {
                    ...
                    i2++;
                    j2 += 500;
                    int i4 = (bArr[i3] + j.e) - 161;
                    int i5 = (bArr[i3 + 1] + j.e) - 161;
                    if (this.d[i4][i5] != (short) 0) {
                        j += (long) this.d[i4][i5];
                    } else if (35 <= i4 && i4 <= 92) {
                        j += 150;
                    }
        ...
        while (i3 < length - 1) {
            ...
            if (bArr[i3] >= (byte) 0) {
                ...
                if (i3 + 1 < bArr.length && ((((byte) -127 <= bArr[i3] && bArr[i3] <= (byte) -97) || ((byte) -32 <= bArr[i3] && bArr[i3] <= (byte) -17)) && (((byte) 64 <= bArr[i3 + 1] && bArr[i3 + 1] <= (byte) 126) || (Byte.MIN_VALUE <= bArr[i3 + 1] && bArr[i3 + 1] <= (byte) -4)))) {
                    ...
                    i6 -= 32;
                    if (i6 >= this.f.length || 32 >= this.f[i6].length || this.f[i6][32] == (short) 0) {
                        j2 = j;
                    } else {
                        j2 = ((long) this.f[i6][32]) + j;
                    }
                    long j4 = j3;
                    i2 = i4;
                    i = i5;
