...
class ab extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f6085f.f6489i.getVisibility() == 8) {
            ...
            f = dv.getAlpha(((((float) this.f6085f.f6486f.getViewportBounds().top) - ((float) this.f6085f.f6489i.getHeight())) / ((float) this.f6085f.f6489i.getHeight())) + 1.0f);
        }
        int parseColor = Color.parseColor("#7a7a7a");
        RectF rectF = (RectF) dv.f1199h.addAnimation();
        int b = ((this.f6080a - this.f6081b) - dv.m1932b(this.f6085f.getContext(), 29.0f)) / 2;
        ...
        canvas.drawRoundRect(rectF, (float) dv.m1932b(this.f6085f.getContext(), 3.0f), (float) dv.m1932b(this.f6085f.getContext(), 3.0f), paint);
        ...
        canvas.drawRoundRect(rectF, (float) dv.m1932b(this.f6085f.getContext(), 3.0f), (float) dv.m1932b(this.f6085f.getContext(), 3.0f), paint);
        int b2 = (int) (rectF.left + ((float) dv.m1932b(this.f6085f.getContext(), 8.0f)));
        ...
        paint2.setTextSize((float) dv.getScaledDensity(this.f6085f.getContext(), 12.0f));
        paint2.setColor(parseColor);
        RectF rectF2 = (RectF) dv.f1199h.addAnimation();
        rectF2.set((float) (dv.m1932b(this.f6085f.getContext(), 8.0f) + b), rectF.top, rectF.right, rectF.bottom);
        dv.m1914a(canvas, this.f6085f.getResources().getString(C0258j.bookshelf__shared__search), rectF2, 19, paint2);
