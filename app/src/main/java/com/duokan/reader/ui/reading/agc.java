...
public class agc extends C0343f {
    ...
    public void m13664a(View view, int i, int i2, boolean z) {
        ...
        this.f9715d.setPadding(0, 0, AnimUtils.m1932b(getContext(), 8.0f), 0);
        int b = AnimUtils.m1932b(getContext(), 25.0f);
        this.f9714c.setPadding(b, b, AnimUtils.m1932b(getContext(), 17.0f), b);
    ...
    public void m13663a(Rect rect) {
        int b = AnimUtils.m1932b(getContext(), 2.0f);
        rect.top -= b;
