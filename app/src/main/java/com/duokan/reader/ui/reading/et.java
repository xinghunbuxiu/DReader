...
public class et extends ek {
    ...
    public et(y yVar, boolean z) {
        ...
        d();
        this.d.setOnDelayedSelectionChangeListener(new ev(this));
    ...
    private void d() {
        ...
        Collections.sort(this.h, new ex(this));
        ...
        while (it2.hasNext()) {
            ...
            if ((this.a || !mVar.c()) && (!this.a || mVar.c())) {
                ...
                inflate.setOnClickListener(new ey(this, (o) mVar));
            }
        }
        b();
    }
    ...
    protected void b() {
        ...
        if (this.a) {
            if (this.b.ae().U().equals("FONT_URI_DEFAULT")) {
                z = true;
            }
            findViewById.setSelected(z);
        } else {
            if (this.b.ae().V().equals("FONT_URI_DEFAULT")) {
                z = true;
            }
            findViewById.setSelected(z);
        }
    ...
    private boolean a(View view, o oVar) {
        ...
        if (oVar.e()) {
            if (this.a) {
                boolean z2;
                if (this.b.ae().U().equals("FONT_URI_SYSTEM")) {
                    z2 = true;
                } else {
                    z2 = false;
                }
                ...
                if (!this.b.ae().V().equals("FONT_URI_SYSTEM")) {
                    z = false;
                }
                findViewById.setSelected(z);
            }
        } else if (this.a) {
            if (!this.b.ae().U().equals(Uri.fromFile(oVar.d()).toString())) {
                z = false;
            }
            findViewById.setSelected(z);
        } else {
            if (!this.b.ae().V().equals(Uri.fromFile(oVar.d()).toString())) {
                z = false;
            }
            findViewById.setSelected(z);
        }
