...
public class ag extends FrameLayout {
    ...
    public ag(Context context, ae aeVar) {
        ...
        inflate.setBackgroundDrawable(new hb(new ColorDrawable(getContext().getResources().getColor(C0252d.general__shared__dialog)), (float) AnimUtils.m1932b(getContext(), 6.0f)));
        addView(inflate);
        ((TextView) findViewById(C0255g.account__share_choice_view__title)).getPaint().setFakeBoldText(true);
        this.f5785c.setDesiredColumnWidth(AnimUtils.m1932b(getContext(), 80.0f));
        this.f5784b = new aj();
        ...
        textView.setBackgroundDrawable(new hb(getContext().getResources().getDrawable(C0254f.general__shared__dialog_button_background), (float) AnimUtils.m1932b(getContext(), 8.0f), 12));
