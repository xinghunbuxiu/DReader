...
class adm extends FrameLayout {
    ...
    public adm(Context context, Drawable drawable) {
        ...
        this.f9522a.addView(enVar, new LayoutParams(dv.m1932b(getContext(), 32.0f), dv.m1932b(getContext(), 32.0f), 17));
        ...
        this.f9523b.addView(enVar, new LayoutParams(dv.m1932b(getContext(), 32.0f), dv.m1932b(getContext(), 32.0f), 17));
        addView(this.f9523b);
    }
