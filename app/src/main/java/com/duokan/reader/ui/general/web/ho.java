...
class ho extends b {
    ...
    protected void onSessionSucceeded() {
        if (this.d.b == 0) {
            ay.a(this.b.b.a.f.b.b.getContext(), this.b.a.getEpubSize(), new hp(this));
            return;
        }
        this.b.b.a.f.b.b.web_notifyWeb(this.b.b.a.b, 2, Mipay.KEY_RESULT, Integer.valueOf(2), Mipay.KEY_MESSAGE, this.d.c);
    }

    protected void onSessionFailed() {
        this.b.b.a.f.b.b.doShowToast(this.b.b.a.f.b.b.getContext().getString(j.general__shared__network_error));
    }

    protected void onSessionClosed() {
        this.a.dismiss();
        if (this.d != null && !TextUtils.isEmpty(this.d.c)) {
            ap apVar = new ap(this.b.b.a.f.b.b.getContext());
