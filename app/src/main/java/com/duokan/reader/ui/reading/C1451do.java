...
class C1451do extends SimpleTarget<Bitmap> {
    ...
    public void m13994a(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
        ...
        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, AnimUtils.getWidthPixels(this.f10035c.getContext()), (bitmap.getHeight() * AnimUtils.getWidthPixels(this.f10035c.getContext())) / bitmap.getWidth(), false);
        if (width < 2.7826087f) {
