...
public class C1405m extends FrameLayout {
    ...
    private void m12238a() {
        ...
        for (C1404l c1404l : this.f8919a) {
            ...
            dkLabelView2.setText(C0267i.m599a(c1404l.f8852c));
            dkLabelView3.setText(String.format(getResources().getString(C0258j.personal__storage_item_view__free_space), new Object[]{C0267i.m599a(c1404l.f8853d)}));
