...
public class k {
    ...
    public k(Context context, String str, String str2, boolean z, r rVar) {
        ...
        this.b.findViewById(g.reading__addnotedlg_view__btns).setPadding(UTools.getMinimumHeight(context, 15.0f), (ReaderEnv.get().forHd() ? 0 : ((ITheme) MyContextWrapper.getFeature(context).queryFeature(ITheme.class)).getTheme().getHeaderPaddingTop()) + UTools.getMinimumHeight(context, 10.0f), UTools.getMinimumHeight(context, 15.0f), UTools.getMinimumHeight(context, 10.0f));
