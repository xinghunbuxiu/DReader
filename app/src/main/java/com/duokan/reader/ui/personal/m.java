...
public class m extends FrameLayout {
    ...
    private void a() {
        ...
        for (l lVar : this.a) {
            ...
            dkLabelView2.setText(tools.getByteSize(lVar.c));
            dkLabelView3.setText(String.format(getResources().getString(j.personal__storage_item_view__free_space), new Object[]{tools.getByteSize(lVar.d)}));
            inflate.setTag(lVar);
