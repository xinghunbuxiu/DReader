...
public class DkSmallFaceView extends bf {
    public DkSmallFaceView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, AnimUtils.m1932b(context, 30.0f), AnimUtils.m1932b(context, 30.0f));
        ...
        layoutParams.leftMargin = AnimUtils.m1932b(context, 4.0f);
        layoutParams.rightMargin = AnimUtils.m1932b(context, 4.0f);
        layoutParams.topMargin = AnimUtils.m1932b(context, 4.0f);
