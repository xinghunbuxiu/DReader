...
public class DkSmallFaceView extends bf {
    public DkSmallFaceView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, UTools.getMinimumHeight(context, 30.0f), UTools.getMinimumHeight(context, 30.0f));
        ...
        layoutParams.leftMargin = UTools.getMinimumHeight(context, 4.0f);
        layoutParams.rightMargin = UTools.getMinimumHeight(context, 4.0f);
        layoutParams.topMargin = UTools.getMinimumHeight(context, 4.0f);
        ...
        layoutParams.bottomMargin = UTools.getMinimumHeight(context, 2.0f);
        layoutParams.rightMargin = UTools.getMinimumHeight(context, 3.0f);
