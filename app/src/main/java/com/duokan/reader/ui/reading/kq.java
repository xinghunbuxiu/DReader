...
class kq extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        rect2.set(rect);
        rect2.offset(0, -AnimUtils.m1932b(this.f10524a.getContext(), 10.0f));
        AnimUtils.m1911a(canvas, this.f10524a.getResources().getDrawable(C0254f.guide__shared__finger_01), rect2, 85);
        rect2.set(rect);
        rect2.inset(-AnimUtils.m1932b(this.f10524a.getContext(), 30.0f), 0);
        paint.setColor(-1);
        paint.setSubpixelText(true);
        paint.setTextSize((float) this.f10524a.getResources().getDimensionPixelSize(C0253e.general_font__shared__d));
        AnimUtils.m1913a(canvas, this.f10524a.getString(C0258j.reading__hang_ad_view__help), rect2, 81, paint);
