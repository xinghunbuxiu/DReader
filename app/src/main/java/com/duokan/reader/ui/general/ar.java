...
public class ar extends LinearLayout {
    ...
    public ar(Context context, AttributeSet attributeSet) {
        ...
        this.f6940d.setLayoutParams(new LayoutParams(-1, AnimUtils.m1932b(getContext(), 29.0f), 17));
    ...
    public void m10234a(int i, int i2) {
        ImageView imageView = (ImageView) this.f6940d.childView.getView(i, this.f6940d).findViewById(C0244f.general__shared__tab_view__num);
        if (i2 == 0) {
