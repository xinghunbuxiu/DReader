...
class pm extends FrameLayout {
    ...
    public pm(Context context, gx gxVar) {
        ...
        for (int i = 0; i < y; i++) {
            ...
            int intrinsicWidth = drawable.getIntrinsicWidth() - AnimUtils.m1932b(getContext(), 8.0f);
            int intrinsicHeight = drawable.getIntrinsicHeight() - AnimUtils.m1932b(getContext(), 8.0f);
    ...
    private void m14917a(int i) {
        ...
        int b2 = AnimUtils.m1932b(getContext(), 10.0f);
