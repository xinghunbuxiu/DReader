...
public class au extends FrameLayout {
    ...
    public au(Context context, as asVar) {
        ...
        inflate.setBackgroundDrawable(new hm(new ColorDrawable(getContext().getResources().getColor(d.general__shared__dialog)), (float) dv.b(getContext(), 6.0f)));
        addView(inflate);
        ...
        textView.setBackgroundDrawable(new hm(getContext().getResources().getDrawable(f.general__shared__dialog_button_background), (float) dv.b(getContext(), 8.0f), 12));
