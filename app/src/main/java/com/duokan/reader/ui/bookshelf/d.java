...
class d implements Runnable {
    ...
    public void run() {
        ...
        r4 = "book.arch";
        r2.<init>(r3, r4);
        com.duokan.core.io.a.d(r1);	 Catch:{ Throwable -> 0x0080, all -> 0x009b }
        ...
        r4 = r7.a;	 Catch:{ all -> 0x0078 }
        r4 = r4.getContext();	 Catch:{ all -> 0x0078 }
        r5 = r7.a;	 Catch:{ all -> 0x0078 }
    ...
    L_0x0055:
        r2 = com.duokan.reader.domain.bookshelf.ai.a();	 Catch:{ Throwable -> 0x0080, all -> 0x009b }
        r3 = r7.a;	 Catch:{ Throwable -> 0x0080, all -> 0x009b }
        r3.a(r1, r2, r0);	 Catch:{ Throwable -> 0x0080, all -> 0x009b }
    L_0x005e:
        r0 = com.duokan.reader.domain.account.i.f();
        r0 = r0.b();
        if (r0 == 0) goto L_0x006f;
    L_0x0068:
        r0 = com.duokan.reader.domain.bookshelf.ai.a();
        r0.a(r6, r6);
    L_0x006f:
        r0 = new com.duokan.reader.ui.bookshelf.e;
        r0.<init>(r7);
        com.duokan.core.sys.t.a(r0);
    L_0x0077:
        return;
    L_0x0078:
        r0 = move-exception;
    ...
    L_0x009b:
        r0 = move-exception;
        r1 = com.duokan.reader.domain.account.i.f();
        r1 = r1.b();
        if (r1 == 0) goto L_0x00ad;
    L_0x00a6:
        r1 = com.duokan.reader.domain.bookshelf.ai.a();
        r1.a(r6, r6);
    L_0x00ad:
        r1 = new com.duokan.reader.ui.bookshelf.e;
        r1.<init>(r7);
        com.duokan.core.sys.t.a(r1);
        throw r0;
    L_0x00b6:
        r1 = move-exception;
        goto L_0x007f;
