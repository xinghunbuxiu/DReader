...
public class be {
    ...
    public static void m9188a(Context context, long j, cm cmVar) {
        ...
        if (j <= 0) {
            ...
            str = context.getString(C0247i.bookshelf__book__download_prompt_at_data_plan, new Object[]{CommonUtils.m599a(j)});
        }
    ...
    public static void m9189b(Context context, long j, cm cmVar) {
        FileTransferPrompter.m9978b(context, j, context.getResources().getString(C0247i.bookshelf__book__upload_prompt__title), context.getString(C0247i.bookshelf__book__upload_prompt_at_data_plan, new Object[]{CommonUtils.m599a(j)}), cmVar);
    }
}
