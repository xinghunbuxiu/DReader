...
class gi implements Runnable {
    ...
    public void run() {
        if (this.f10239a) {
            ...
            AnimUtils.m1945c(point, this.f10241c.f10223c);
            Point point2 = new Point(this.f10240b.x - point.x, this.f10240b.y - point.y);
            AnimUtils.m1896a(point2, this.f10241c);
            ...
            AnimUtils.m1897a(this.f10241c.f10222b, this.f10241c, this.f10241c.f10223c);
