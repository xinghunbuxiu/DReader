...
public class bz extends ak implements C0306j {
    ...
    public bz(Context context) {
        ...
        int b = dv.m1932b(getContext(), 6.0f);
        ...
        textView.setBackgroundDrawable(new hb(getContext().getResources().getDrawable(C0243e.general__shared__dialog_button_background), (float) dv.m1932b(getContext(), 6.0f), 4));
        textView.setOnClickListener(new ca(this));
        textView = (TextView) findViewById(C0244f.general__edit_dialog_view__ok);
        textView.getPaint().setFakeBoldText(true);
        textView.setBackgroundDrawable(new hb(getContext().getResources().getDrawable(C0243e.general__shared__dialog_button_background), (float) dv.m1932b(getContext(), 6.0f), 8));
