    ...
    public void a() {
        ...
        if (optJSONArray.length() != 0) {
            ...
            if (optJSONArray.length() < 2) {
                ...
                e storePageController = new StorePageController(this.a.b.b.getContext());
                storePageController.loadUrl(optString2);
                storePageController.setPageTitle(optString);
                eVar = storePageController;
            } else {
                e jaVar = new ja(this.a.b.b.getContext());
                for (int i = 0; i < optJSONArray.length(); i++) {
                    JSONObject jSONObject2 = optJSONArray.getJSONObject(i);
                    String optString3 = jSONObject2.optString("title", "");
                    String optString4 = jSONObject2.optString("url");
                    e storePageController2 = new StorePageController(this.a.b.b.getContext());
            ...
            ((ReaderFeature) this.a.b.b.getContext().queryFeature(ReaderFeature.class)).pushPageSmoothly(eVar, null);
        }
    }
}
