...
class hg implements Runnable {
    ...
    public void run() {
        ...
        r2 = r2.a;
        r3 = r2.d();
        r2 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.c;	 Catch:{ Throwable -> 0x00af }
        r4 = new com.duokan.core.b.a.a;	 Catch:{ Throwable -> 0x00af }
        r4.<init>();	 Catch:{ Throwable -> 0x00af }
        r5 = r10.b;	 Catch:{ Throwable -> 0x00af }
        r4 = r4.a(r5);	 Catch:{ Throwable -> 0x00af }
        r5 = 131072; // 0x20000 float:1.83671E-40 double:6.47582E-319;
        r4 = r4.b(r5);	 Catch:{ Throwable -> 0x00af }
        com.duokan.core.b.a.b.a(r3, r2, r4);	 Catch:{ Throwable -> 0x00af }
        r2 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.c;	 Catch:{ Throwable -> 0x00af }
        r4 = r2.b();	 Catch:{ Throwable -> 0x00af }
        r2 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.d;	 Catch:{ Throwable -> 0x00af }
        r6 = "md5";
        r6 = com.duokan.core.sys.o.a(r2, r6);	 Catch:{ Throwable -> 0x00af }
        r2 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.a;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.e();	 Catch:{ Throwable -> 0x00af }
    ...
    L_0x0044:
        r7 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r7 = r7.a;	 Catch:{ Throwable -> 0x00af }
        r7 = r7.f();	 Catch:{ Throwable -> 0x00af }
        r7 = r6.startsWith(r7);	 Catch:{ Throwable -> 0x00af }
        if (r7 == 0) goto L_0x0089;
    L_0x0052:
        r1 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r1.e = r0;	 Catch:{ Throwable -> 0x00af }
        if (r2 != 0) goto L_0x008b;
    L_0x0058:
        r0 = com.duokan.core.diagnostic.a.c();	 Catch:{ Throwable -> 0x00af }
        ...
        r4 = 2;
        r5 = r10.a;	 Catch:{ Throwable -> 0x00af }
        r5 = r5.a;	 Catch:{ Throwable -> 0x00af }
        r5 = r5.e();	 Catch:{ Throwable -> 0x00af }
    ...
    L_0x00af:
        r0 = move-exception;
        r1 = r10.a;	 Catch:{ all -> 0x00d9 }
        r2 = 0;
        r1.e = r2;	 Catch:{ all -> 0x00d9 }
        r1 = com.duokan.core.diagnostic.a.c();	 Catch:{ all -> 0x00d9 }
        ...
        r1.a(r2, r4, r3, r0);	 Catch:{ all -> 0x00d9 }
        r0 = r10.c;
        r0.release();
        goto L_0x0086;
    L_0x00d9:
