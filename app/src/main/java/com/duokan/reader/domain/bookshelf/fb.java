...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:162:? in {11, 20, 42, 65, 70, 71, 73, 74, 95, 118, 120, 137, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 163, 164} preds:[]
...
*/
    ...
    L_0x002c:
        ...
        goto L_0x0008;
    L_0x002e:
        r2 = r10.c;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x0036:
        r0 = r10.b;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r10.c;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0.a(r1, r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    L_0x003d:
        r0 = r10.b;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r0.d(r1);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r4 = com.duokan.core.b.a.b.a(r11, r2, r12);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x004d:
        r6 = r10.c;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x0055:
        ...
        if (r0 == 0) goto L_0x0085;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    L_0x005b:
        r0 = com.duokan.core.diagnostic.a.c();	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        ...
        r7 = "unexpected file length(length=%d, httpUri=%s, fileUri=%s)";	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        ...
        r5 = r10.a;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r8[r4] = r5;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0.a(r3, r6, r7, r8);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = 1007; // 0x3ef float:1.411E-42 double:4.975E-321;
        com.duokan.core.io.d.a(r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r10.b;
        r2.b(r1);
        goto L_0x0008;
    L_0x0085:
        com.duokan.core.io.d.a(r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r10.b;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r0.c(r1);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r10.e;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x009e:
        ...
        r3 = com.duokan.core.sys.o.a(r2, r0);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r10.e;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x00c5:
        r0 = move-exception;
        r2 = r10.b;	 Catch:{ all -> 0x012e }
        r3 = r10.a;	 Catch:{ all -> 0x012e }
        r2 = r2.a(r3);	 Catch:{ all -> 0x012e }
    ...
    L_0x010a:
        com.duokan.core.io.d.a(r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r10.b;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r10.a;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r0.a(r1, r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        if (r0 != 0) goto L_0x0138;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    L_0x0117:
        r0 = r10.b;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r2 = r10.a;	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
        r0 = r0.a(r2);	 Catch:{ all -> 0x0129, all -> 0x00c0, Throwable -> 0x00c5 }
    ...
    L_0x0138:
        ...
        goto L_0x0008;
    L_0x0140:
        r10.i = r0;	 Catch:{ all -> 0x012e }
        r2 = com.duokan.core.diagnostic.a.c();	 Catch:{ all -> 0x012e }
    ...
    L_0x0199:
        ...
        r0 = r0.toString();
        r2.<init>(r0);
        r4 = com.duokan.core.b.a.b.a(r11, r2, r12);	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    ...
    L_0x01bf:
        r6 = r10.c;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    ...
    L_0x01c7:
        ...
        if (r0 == 0) goto L_0x01f3;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    L_0x01cd:
        r0 = com.duokan.core.diagnostic.a.c();	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        ...
        r7 = "unexpected file length(length=%d, httpUri=%s, fileUri=%s)";	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        ...
        r5 = r10.a;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r8[r4] = r5;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r0.a(r3, r6, r7, r8);	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r0 = 1007; // 0x3ef float:1.411E-42 double:4.975E-321;
        com.duokan.core.io.a.d(r2);
        goto L_0x0008;
    L_0x01f3:
        r0 = r10.e;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    ...
    L_0x0203:
        ...
        r3 = com.duokan.core.sys.o.a(r2, r0);	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r0 = r10.e;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    ...
    L_0x026f:
        ...
        goto L_0x0008;
    L_0x0275:
        r10.i = r0;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r1 = com.duokan.core.diagnostic.a.c();	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
        r3 = com.duokan.core.diagnostic.LogLevel.ERROR;	 Catch:{ Throwable -> 0x0268, all -> 0x02b0 }
    ...
    L_0x02b0:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.duokan.reader.domain.bookshelf.fb.a(java.lang.String, com.duokan.core.b.a.a):int");
    }
