...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_2 'getPhysicalYPixels' int) = (r1_0 'getPhysicalYPixels' int), (r1_1 'getPhysicalYPixels' int) binds: {(r1_1 'getPhysicalYPixels' int)=B:21:0x0071, (r1_0 'getPhysicalYPixels' int)=B:32:0x003d} in method: com.duokan.reader.domain.bookshelf.jv.bn():java.util.List
