...
public class DkPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage miPushMessage) {
        WebLog.init().c(LogLevel.EVENT, "push", String.format("class: %s, method: %s, message: %s", new Object[]{TAG, "onReceivePassThroughMessage", miPushMessage.toString()}));
        C0880y.m5742a().m5751a(miPushMessage);
    }

    public void onNotificationMessageClicked(Context context, MiPushMessage miPushMessage) {
        WebLog.init().c(LogLevel.EVENT, "push", String.format("class: %s, method: %s, message: %s", new Object[]{TAG, "onNotificationMessageClicked", miPushMessage.toString()}));
        C0880y.m5742a().m5751a(miPushMessage);
        try {
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage miPushMessage) {
        WebLog.init().c(LogLevel.EVENT, "push", String.format("class: %s, method: %s, message: %s", new Object[]{TAG, "onNotificationMessageArrived", miPushMessage.toString()}));
    ...
    public void onCommandResult(Context context, MiPushCommandMessage miPushCommandMessage) {
        WebLog.init().c(LogLevel.EVENT, "push", String.format("class: %s, method: %s, message: %s", new Object[]{TAG, "onCommandResult", miPushCommandMessage.toString()}));
    }

    public void onReceiveRegisterResult(Context context, MiPushCommandMessage miPushCommandMessage) {
        WebLog.init().c(LogLevel.EVENT, "push", String.format("class: %s, method: %s, message: %s", new Object[]{TAG, "onReceiveRegisterResult", miPushCommandMessage.toString()}));
        ...
        if ("register".equals(command) && miPushCommandMessage.getResultCode() == 0) {
            WebLog.init().c(LogLevel.EVENT, "push", "register success");
