...
public class b {
    static final boolean a = (!b.class.desiredAssertionStatus());

    public static void a(Context context, c cVar, HashMap hashMap, List<a> list) {
        if (a || (list != null && list.size() > 0)) {
            Intent intent = new Intent("android.intent.action.SEND");
            UserAccount c = i.f().c();
            String c2 = c == null ? "" : c.c();
            intent.putExtra("android.intent.extra.EMAIL", new String[]{c2});
            String format = String.format(context.getString(R.String.reading__export_notes_title), new Object[]{cVar.aw()});
            if (TextUtils.isEmpty(cVar.B())) {
                c2 = "";
            } else {
                c2 = String.format(context.getString(R.String.reading__export_notes_author), new Object[]{cVar.B()});
            }
    ...
    public static void a(Context context, List<DkCloudComment> list, String str, String str2) {
        if (a || (list != null && list.size() > 0)) {
            ...
            String c2 = c == null ? "" : c.c();
            intent.putExtra("android.intent.extra.EMAIL", new String[]{c2});
            c2 = String.format(context.getString(R.String.reading__export_notes_title), new Object[]{str});
            if (!TextUtils.isEmpty(str2)) {
                c2 = c2 + String.format(context.getString(R.String.reading__export_notes_author), new Object[]{str2});
            }
