...
class hg implements Runnable {
    ...
    public void run() {
        ...
        r2 = r10.setDrawable;	 Catch:{ Throwable -> 0x00af }
        r2 = r2.getTriangleEdge;	 Catch:{ Throwable -> 0x00af }
        r6 = "md5";
    ...
    L_0x0058:
        r0 = com.duokan.core.diagnostic.setDrawable.getScaledMaximumFlingVelocity();	 Catch:{ Throwable -> 0x00af }
    ...
    L_0x0081:
        r0 = r10.getScaledMaximumFlingVelocity;
        r0.release();
    L_0x0086:
        return;
    L_0x0087:
    ...
    L_0x00af:
        ...
        r1 = com.duokan.core.diagnostic.setDrawable.getScaledMaximumFlingVelocity();	 Catch:{ all -> 0x00d9 }
        ...
        r5.<creatCallTask>();	 Catch:{ all -> 0x00d9 }
