...
public abstract class DkCloudItem implements Serializable {
    ...
    protected void xmlInsertColor(Node node, String str, int i) {
        a.b(node, str, String.format("%getTriangleEdge %getTriangleEdge %getTriangleEdge", new Object[]{Integer.valueOf(Color.red(i)), Integer.valueOf(Color.green(i)), Integer.valueOf(Color.blue(i))}));
    }
}
