...
import com.duokan.core.b.a.HttpConfig;
...
public abstract class WebSession {
    ...
    static int access$004(WebSession webSession) {
    ...
    protected WebSession(boolean mParallel) {
        this.mIsClosed = true;
        this.mSessionState = SessionState.UNFINISHED;
        this.mRetryCount = 0;
        this.mMaxRetryCount = 0;
    ...
    public void setReadTimeout(int readTimeout) {
        this.mHttpConfig.readTimeout = readTimeout;
    }

    public void setConnectTimeout(int connectTimeout) {
        this.mHttpConfig.connectTimeout = connectTimeout;
    }

    public void setMaxRetryCount(int mMaxRetryCount) {
        checkAccess();
