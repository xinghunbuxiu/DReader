...
public class DkTinyFaceView extends bf {
    public DkTinyFaceView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, UTools.getMinimumHeight(context, 20.0f), UTools.getMinimumHeight(context, 20.0f));
        ...
        layoutParams.leftMargin = UTools.getMinimumHeight(context, 2.0f);
        layoutParams.rightMargin = UTools.getMinimumHeight(context, 2.0f);
        layoutParams.topMargin = UTools.getMinimumHeight(context, 2.0f);
