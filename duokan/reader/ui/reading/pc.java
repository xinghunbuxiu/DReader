...
class pc extends FrameLayout {
    ...
    public pc(Context context, gs gsVar) {
        ...
        for (int i = 0; i < y; i++) {
            ...
            int intrinsicWidth = drawable.getIntrinsicWidth() - UTools.getMinimumHeight(getContext(), 8.0f);
            int intrinsicHeight = drawable.getIntrinsicHeight() - UTools.getMinimumHeight(getContext(), 8.0f);
    ...
    private void a(int i) {
        ...
        int b2 = UTools.getMinimumHeight(getContext(), 10.0f);
        ...
        zoomView.setMaxOverScrollHeight(UTools.getMinimumHeight(getContext()));
